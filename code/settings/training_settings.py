...
class TrainingSettings(ModelSettings):
    ...
    def __init__(self):
        ...
        self.VALIDATION_LMDB = os.path.join(self.BASE_PATH, 'data', 'processed', 'lmdb', 'validation-lmdb')
	...
	self.CLIP_GRAD_NORM = 10.0      # max l2 norm of gradient of parameters - use 0 to disable it
        ...
        #self.CROP_SCALE = (1.0, 1.0)      # Choose it carefully - have a look at lib/preprocess.py -> RandomResizedCrop
        #self.CROP_AR = (1.0, 1.0)         # Choose it carefully - have a look at lib/preprocess.py -> RandomResizedCrop
