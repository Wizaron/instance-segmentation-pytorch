...
train_align_collate = AlignCollate('training', ts.MAX_N_OBJECTS, ts.MEAN,
...
test_align_collate = AlignCollate('test', ts.MAX_N_OBJECTS, ts.MEAN, ts.STD,
