...
ANN_DIR = os.path.join(DATA_DIR, 'raw', 'CVPPP', 'CVPPP2017_LSC_training', 'training', 'A1')
IMG_DIR = os.path.join(DATA_DIR, 'raw', 'CVPPP', 'CVPPP2017_LSC_training', 'training', 'A1')
SEMANTIC_OUTPUT_DIR = os.path.join(DATA_DIR, 'processed', 'CVPPP', 'semantic-annotations')
INSTANCE_OUTPUT_DIR = os.path.join(DATA_DIR, 'processed', 'CVPPP', 'instance-annotations')
...
for image_path in image_paths:
    ...
    instance_mask = np.zeros((img_height, img_width, n_instances), dtype=np.uint8)
    ...
    np.save(os.path.join(INSTANCE_OUTPUT_DIR, image_name + '.npy'), instance_mask)
    np.save(os.path.join(SEMANTIC_OUTPUT_DIR, image_name + '.npy'), semantic_mask)
